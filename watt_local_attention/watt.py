...
localAttention = load(
        "emd_cuda",
        sources=[
            os.path.join(module_path, "src/similar.cu"),
            os.path.join(module_path, "src/weighting.cu"),
            os.path.join(module_path, "localAttention.cpp"),
        ],
...
similar_forward = localAttention.similar_forward
similar_backward = localAttention.similar_backward
weighting_forward = localAttention.weighting_forward
weighting_backward_ori = localAttention.weighting_backward_ori
weighting_backward_weight = localAttention.weighting_backward_weight
